...
angular.module('app')
    // Chart controller 
    .controller('DashboardCtrl', ['$scope', '$http', '$timeout','urls','$window', function($scope, $http, $timeout,urls,$window) {
    	 ...
    	 $http.get(urls.getAllUsers).success(function(data){
     		...
     		$scope.userCount=$scope.allUsers.length;
     		$scope.adminCount=0;
    	 ...
    	 $scope.openUserPage=function(){
    		 $window.location.href = '#/app/tables/basic'
    	 }
